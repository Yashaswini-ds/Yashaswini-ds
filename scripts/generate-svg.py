...
def generate_svg(loc_data):
  ...
  <rect width="{svg_width}" height="{svg_height}" fill="#0f172a" rx="10"/>
  ...
  <text x="40" y="130" font-family="'SF Mono', 'Monaco', 'Courier New', monospace" font-size="16" font-weight="600" fill="#2dd4bf">
    TOP LANGUAGES
  </text>
'''
